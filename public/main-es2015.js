...
let LoginComponent = class LoginComponent {
    constructor(vs, ngFMS, router, auth) {
        this.vs = vs;
        this.ngFMS = ngFMS;
        this.router = router;
        this.auth = auth;
...
let RegisterComponent = class RegisterComponent {
    constructor(vs, auth, ngFMS, router) {
        this.vs = vs;
        this.auth = auth;
        this.ngFMS = ngFMS;
        this.router = router;
...
let TodoItemComponent = class TodoItemComponent {
    ...
    todoSubmit() {
        ...
        if (data.todo == []) {
            ...
            this.auth.addTodo(data).subscribe((res) => {
                if (res.success) {
                    this.ngFMS.showFlashMessage({
...
let TodoListComponent = class TodoListComponent {
    ...
    refresh() {
        ...
        this.auth.getUserById(user._id).subscribe((data) => {
            console.log(data);
    ...
    todoSubmit(_id, todo) {
        this.auth.editTodo(_id, todo).subscribe((res) => {
            if (res.success) {
                this.ngFMS.showFlashMessage({
