...
module.exports = "<app-todo-item></app-todo-item>\n<app-todo-list></app-todo-list>"
...
module.exports = "<form (ngSubmit)=\"loginFormSubmit()\">\n    <div class=\"form-group\">\n      <input type=\"email\" class=\"form-control\" id=\"email\" placeholder=\"Email\" required name=\"email\"  [(ngModel)]=\"email\">\n    </div>\n    <div class=\"form-group\">\n      <input type=\"password\" class=\"form-control\" id=\"password\" placeholder=\"Password\" required name=\"password\" name=\"password\" [(ngModel)]=\"password\">\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\" >Login</button>\n</form>\n"
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-dark bg-dark mb-3\">\n    <a class=\"navbar-brand\" href=\"#\">{{title}}</a>\n    <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\" aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n      <span class=\"navbar-toggler-icon\"></span>\n    </button>\n  \n    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">\n      <ul class=\"navbar-nav mr-auto\">\n        <li class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n          <a class=\"nav-link btn btn-dark\" [routerLink]=\"['/']\">Home</a>\n        </li>\n      </ul>\n      <ul class=\"navbar-nav my-2\">\n          <li *ngIf=\"auth.loggedIn()\" class=\"nav-item custom-width\">\n              <a class=\"nav-link btn btn-dark\" [routerLink]=\"['/profile']\">Profile</a>\n          </li>\n          <li *ngIf=\"auth.loggedIn()\" class=\"nav-item custom-width\">\n              <a class=\"nav-link btn btn-dark\" [routerLink]=\"['/dashboard']\">Dashboard</a>\n          </li>\n          <li *ngIf=\"!auth.loggedIn()\" class=\"nav-item custom-width\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n              <a class=\"nav-link btn btn-dark \" [routerLink]=\"['/login']\">Login</a>\n          </li>\n          <li *ngIf=\"!auth.loggedIn()\" class=\"nav-item  custom-width\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\">\n              <a class=\"nav-link btn btn-dark\" [routerLink]=\"['/register']\">Register</a>\n          </li>\n          <li *ngIf=\"auth.loggedIn()\" class=\"nav-item custom-width\">\n              <a class=\"nav-link btn btn-dark\" href = '#' (click)='logout()'>Logout</a>\n          </li>\n      </ul>\n    </div>\n  </nav>"
...
module.exports = "<form (ngSubmit)=\"registerFormSubmit()\" >\n    <div class=\"form-group\">\n        <input type=\"text\" class=\"form-control\" id=\"name\" placeholder=\"Name\" required name=\"name\"  [(ngModel)]=\"name\">\n    </div>\n    <div class=\"form-group\">\n      <input type=\"email\" class=\"form-control\" id=\"email\" placeholder=\"Email\" required name=\"email\"  [(ngModel)]=\"email\" pattern=\"^\\S*[@]\\S*[.]\\S*$\">\n    </div>\n    <div class=\"form-group\">\n        <input type=\"password\" class=\"form-control\" id=\"password\" placeholder=\"Password\" required name=\"password\" name=\"password\" [(ngModel)]=\"password\">\n      </div>\n    <button type=\"submit\" class=\"btn btn-primary\" >Register</button>\n  </form>\n"
...
module.exports = "<form (ngSubmit)=\"todoSubmit()\">\n    <div class=\"input-group mb-3\">\n        <div class=\"input-group-prepend\">\n          <div class=\"input-group-text\">\n            <input type=\"checkbox\" aria-label=\"Checkbox for following text input\" name=\"completed\" [(ngModel)]=\"todo.completed\">\n          </div>\n        </div>\n        <input type=\"text\" class=\"form-control\" aria-label=\"Text input with checkbox\" name=\"todo\" placeholder=\"Enter your todo!\" [(ngModel)]=\"todo.title\">\n        <div class=\"input-group-append\">\n            <button class=\"btn btn-outline-secondary\" type=\"submit\">Save</button>\n        </div>\n    </div>\n</form>\n"
...
module.exports = "<div>\n    <button class=\"btn btn-outline-secondary\" type=\"button\" (click)=\"refresh()\">Refresh</button>\n</div>\n<div *ngFor=\"let todo of todos\">\n  <form (ngSubmit)=\"todoSubmit(todo._id,todo)\">\n      <div class=\"input-group mb-3\">\n          <div class=\"input-group-prepend\">\n            <div class=\"input-group-text\">\n              <input type=\"checkbox\" aria-label=\"Checkbox for following text input\" name=\"completed\" [(ngModel)]=\"todo.completed\">\n            </div>\n          </div>\n          <input type=\"text\" class=\"form-control\" aria-label=\"Text input with checkbox\" name=\"title\" placeholder=\"Enter your todo!\" [(ngModel)]=\"todo.title\">\n          <div class=\"input-group-append\">\n              <button class=\"btn btn-outline-secondary\" type=\"submit\">Edit Todo</button>\n          </div>\n      </div>\n  </form>\n</div>"
...
var routes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_8__["DashboardComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_6__["ProfileComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_7__["AuthGuardService"]] }
];
...
/* harmony import */ var _components_todo_item_todo_item_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/todo-item/todo-item.component */ "./src/app/components/todo-item/todo-item.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _components_todo_item_todo_item_component__WEBPACK_IMPORTED_MODULE_10__["TodoItemComponent"],
            ...
            providers: [_services_validation_service__WEBPACK_IMPORTED_MODULE_13__["ValidationService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_14__["AuthService"], _services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuardService"]],
...
module.exports = ".container{\r\n    background-color: gray;\r\n    padding: 150px;\r\n    \r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".form{\r\n    margin-top: 20px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(vs, ngFMS, router, auth) {
        this.vs = vs;
        this.ngFMS = ngFMS;
        this.router = router;
        this.auth = auth;
    ...
    LoginComponent.prototype.loginFormSubmit = function () {
        var _this = this;
        var user = {
            email: this.email,
        ...
        if (this.vs.validateEmail(user.email)) {
            this.auth.authenticate(user).subscribe(function (data) {
                if (data.success) {
                    _this.auth.storeUserData(data.token, data.user);
                    _this.ngFMS.showFlashMessage({
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_validation_service__WEBPACK_IMPORTED_MODULE_2__["ValidationService"],
...
module.exports = ".custom-width{\r\n    margin-left: 10px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(auth, ngFMS, router) {
        this.auth = auth;
        this.ngFMS = ngFMS;
        this.router = router;
    }
...
module.exports = ".form{\r\n    margin-top: 20px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(vs, auth, ngFMS, router) {
        this.vs = vs;
        this.auth = auth;
        this.ngFMS = ngFMS;
        this.router = router;
    ...
    RegisterComponent.prototype.registerFormSubmit = function () {
        var _this = this;
        var user = {
            name: this.name,
            email: this.email,
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvdG9kby1pdGVtL3RvZG8taXRlbS5jb21wb25lbnQuY3NzIn0= */"
...
var TodoItemComponent = /** @class */ (function () {
    function TodoItemComponent(auth, ngFMS, router) {
        this.auth = auth;
        this.ngFMS = ngFMS;
        this.router = router;
    ...
    TodoItemComponent.prototype.todoSubmit = function () {
        var _this = this;
        var data = {
            email: this.email,
            todo: this.todo
        ...
        if (data.todo == []) {
            ...
            this.auth.addTodo(data).subscribe(function (res) {
                if (res.success) {
                    _this.ngFMS.showFlashMessage({
    ...
    TodoItemComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], ng_flash_messages__WEBPACK_IMPORTED_MODULE_3__["NgFlashMessageService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], TodoItemComponent);
...
var TodoListComponent = /** @class */ (function () {
    function TodoListComponent(auth, ngFMS) {
        this.auth = auth;
        this.ngFMS = ngFMS;
    ...
    TodoListComponent.prototype.refresh = function () {
        ...
        this.auth.getUserById(user._id).subscribe(function (data) {
            console.log(data);
            _this.todos = data.message;
        }, function (err) {
            console.log(err);
        });
    };
    TodoListComponent.prototype.todoSubmit = function (_id, todo) {
        var _this = this;
        this.auth.editTodo(_id, todo).subscribe(function (res) {
            if (res.success) {
                _this.ngFMS.showFlashMessage({
    ...
    TodoListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], ng_flash_messages__WEBPACK_IMPORTED_MODULE_3__["NgFlashMessageService"]])
    ], TodoListComponent);
...
var AuthService = /** @class */ (function () {
    ...
    // add todo
    AuthService.prototype.addTodo = function (data) {
        var todo = {
            email: data.email,
            todo: data.todo
        };
    ...
    // list todos
    AuthService.prototype.listTodos = function (_id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.set('Content-Type', 'application/json');
        return this.http.post('users/listtodos', _id, { headers: headers });
    };
    // edit todo
    AuthService.prototype.editTodo = function (id, todo) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.set('Content-Type', 'application/json');
...
module.exports = __webpack_require__(/*! D:\New folder (6)\Todo\angular-src\src\main.ts */"./src/main.ts");
