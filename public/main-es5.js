...
/* harmony import */ var _services_validation_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/validation.service */ "./src/app/services/validation.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_services_validation_service__WEBPACK_IMPORTED_MODULE_11__["ValidationService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_12__["AuthService"], _services_auth_guard_service__WEBPACK_IMPORTED_MODULE_15__["AuthGuardService"]],
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(auth, ngFMS, router) {
        this.auth = auth;
        this.ngFMS = ngFMS;
        this.router = router;
        this.todos = [];
    ...
    DashboardComponent.prototype.todoSubmit = function () {
        var _this = this;
        var data = {
            email: this.email,
            todo: this.todo
            ...
            if (data.todo == []) {
                ...
                this.auth.addTodo(data).subscribe(function (res) {
                    if (res.success) {
                        ...
                        _this.todo.title = null;
                        _this.todo.completed = false;
                    }
                    else {
                        _this.ngFMS.showFlashMessage({
                            messages: [res.message],
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.updateStatus = function (todo, userId) {
        var task = {
            userID: userId,
            _id: todo._id,
            todo: todo
...
module.exports = __webpack_require__(/*! D:\Git\Todo\angular-src\src\main.ts */"./src/main.ts");
